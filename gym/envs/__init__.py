...
register(
    id='HalfCheetahT-v3',
    entry_point='gym.envs.mujoco.half_cheetah_t_v3:HalfCheetahEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
register(
    id='HopperT-v3',
    entry_point='gym.envs.mujoco.hopper_t_v3:HopperEnv',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
...
register(
    id='Walker2dT-v3',
    max_episode_steps=1000,
    entry_point='gym.envs.mujoco.walker2d_t_v3:Walker2dEnv',
)
...
register(
    id='AntT-v3',
    entry_point='gym.envs.mujoco.ant_t_v3:AntEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
