...
def run(args):
    ...
    # env = make_env(args.env_id, sparse_reward=True)
    # env_test = make_env(args.env_id, sparse_reward=True)

    _, env, env_test = setup_envs(None, args.env_id, args.env_id.startswith("darc_envs:"))
