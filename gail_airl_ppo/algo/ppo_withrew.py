...
class PPO_WITHREW(Algorithm):
    ...
    def update(self, writer):
        ...
        states, actions, true_rewards, dones, log_pis, next_states = \
            self.buffer.get()
        rewards = self.rew(states)
        self.update_ppo(
...
class PPOAgent_WITHREW(PPO_WITHREW):
